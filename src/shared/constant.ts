...
export const tagOptions: Option[] = [
  { value: "🧗‍♂️ Climbing", label: "Climbing  🧗‍♂️", color: "#944900" },
  { value: "💻 Work", label: "Work  💻 ", color: "#8c8c8c" },
  { value: "✈️ Travel", label: "Travel ✈️", color: "#00B8D9" },
  { value: "❤️ Relationship", label: "Relationship ❤️", color: "#d40000" },
];
